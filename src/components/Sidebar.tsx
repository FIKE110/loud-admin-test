    ...
    <aside className="fixed inset-y-0 left-0 z-30 flex h-screen w-[256px] flex-col bg-[#06102F]">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && (
                <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-[#2561EE] text-[10px] font-bold text-white">
                  {item.badge}
                </span>
              )}
            </Link>
      ...
      <div className="border-t border-white/10 px-6 py-4">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#2561EE] to-[#1A4FCC] text-sm font-bold text-white">
            IM
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-white truncate">Ikechukwu</p>
